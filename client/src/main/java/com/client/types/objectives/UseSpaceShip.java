...
/**
 * Classe che rappresenta l'obiettivo che riguarda l'utilizzare la SpaceShip.
 *
 ...
 * @see Objective
 */
public class UseSpaceShip extends Objective {

    /**
     * Costruttore della classe UseSpaceShip.
     * 
     * @param id numero obiettivo.
     * @param db il database dal quale leggere le varie informazioni dell'obiettivo UseSpaceShip.
     * 
     * @throws SQLException per eventuali problemi con il database o l'SQL. 
     */
    public UseSpaceShip(int id, DB db) throws SQLException {
        super(id, db);
    }
