...
/**
 * Classe che estende il tipo Room e crea l'istanza della stanza <b>Cucina e
 * Sala mensa</b>.
 *
...
public class Kitchen extends Room {
    ...
    /**
     * Costruttore della classe Kitchen.
     *
     ...
     */
    public Kitchen(String name, DB db, List<Item> items) throws SQLException {
        super(name, db, items);
    }
}
