...
/**
 * Classe che estende il tipo Room e crea l'istanza della stanza <b>Zona
 * Comune</b>.
 *
 ...
 */
public class CommonZone extends Room {

    /**
     * Costruttore della classe CommonZone.
     *
     ...
     */
    public CommonZone(String name, DB db, List<Item> items)
            throws SQLException {
        super(name, db, items);
    }
}
