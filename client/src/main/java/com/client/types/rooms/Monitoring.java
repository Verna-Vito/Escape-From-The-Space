 ...
 * Monitoraggio Terra e Zona di lancio</b>.
 *
 ...
 */
public class Monitoring extends Room {

    /**
     * Costruttore della classe Monitoring.
     *
     ...
     */
    public Monitoring(String name, DB db, List<Item> items) 
            throws SQLException {
        super(name, db, items);
    }
}
