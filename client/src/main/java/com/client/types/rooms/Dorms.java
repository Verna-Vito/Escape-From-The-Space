...
/**
 * Classe che estende il tipo Room e crea l'istanza della stanza
 * <b>Dormitori</b>.
 *
 ...
 */
public class Dorms extends Room {

    /**
     * Costruttore della classe Dorms.
     *
     ...
     */
    public Dorms(String name, DB db, List<Item> items) throws SQLException {
        super(name, db, items);
    }
}
