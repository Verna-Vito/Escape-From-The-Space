...
/**
 * Classe che rappresenta il Display, uno degli Item di questo gioco.
 *
...
public class Display extends Item {
     ...
     * @param db il database dal quale leggere le varie informazioni del display
     *
     * @throws SQLException per eventuali problemi con l'SQL e/o con il DB
     */
    public Display(String name, DB db) throws SQLException {
        super(name, db);
    }
}
